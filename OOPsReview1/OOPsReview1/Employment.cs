...
namespace OOPsReview1.Data
{
    public class Employment
    {
        ...
        //data field(data members)
        //property
        //constructor
        //behaviour(method)

        //data fields
        //are strong areas in your class
        //these are treated as variables
        //these may be public, private, public readomly
        ...
        //if no set, the property is not changable by the user; readomly
        ...
        //      if the set is private the only wy to place data into this property is 
        //        via the constructor or a behaviour ( method)

        //When:
        //a) if you are storing the associate data is an explicitly declared data field
        //b) is you are doing validation on incoming data
        ...
        public string Title
        {
            ...
            set
            {
                ...
                //during the setting, you might wish to do same type of logical
        ...
        //the system manages the internak storage for the accessor and mutator
        ...
        public Employment()
        {
            ...
            // the value that you give your class data members/properties CAN be assigned 
            //          directly to a data member
            //However: if you have valiadated properties, you SHOULD consider saving your
        ...
        public Employment(string title, SupervisoryLevel level, double years = 0.0)
        {
            ...
            //b) You COULD code your valiadation in this constructor
            //c)valiadation for public readonly data members MUST be done here
            //d) validation for properties with a private set can be done here
            //       if not done in the property 

            //default parameters

            //WHY? it allows the programer to use your constructor/methos with having to
            // specify all argument in the code to your constructor/method
            //
            //location: end of parameter list
            //How many: as many as you wish
            //values for your default parameter must be a valid value
            //position and order of specified defaut parameters are important when the
            //  program uses the constructor/method.
            //default parameter can be skipped, however, you still must account for the
            //  skipped parameter in your argument call list using commas
            //by giving the default parameter in argument value on the call, the constructor/method
            //  default value is overridden

            //syntax: datatype parametername = default value
            //example: years on this constructor is default parametr

            //example: skipped defaults (3 default paramters, second one skipped
        ...
        //Behaviour (a.k.a. method)
        //a behaviour is any method in your class
        //behaviour can be private (for use by the class only); public (for use by the outside
        //  user
